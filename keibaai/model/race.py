...
class RaceUma(base):
    ...
    uma_id = Column(String(10), primary_key=True)
    ...
    jockey_id = Column(String(5))
    time = Column(Interval)
    margin = Column(String(6))
    ninki = Column(SmallInteger)
    win_odds = Column(Float)
    final_3_furlong = Column(Float)
    corner_order = Column(String(12))
    trainer_id = Column(String(5))
    horse_weight = Column(SmallInteger)
    gain_and_loss_weight = Column(SmallInteger)
    is_excluded = Column(String(1), default="0")
    is_demoted = Column(String(1), default="0")
